...
export function Sidebar() {
    return (
        <div className="flex h-screen w-64 flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-accent">
                    ...
                    {navigation.map((item) => (
                        <Link
                            ...
                            className={cn(
                                ...
                                item.href === "/" && "bg-sidebar-accent text-sidebar-foreground" // Active state for demo
                            )}
                        >
